...
function ActiveCourses() {
  ...
  const handelShowBigDiv = (userdata) => {
    console.log(userdata);
    navigate('/courseview', { userdata });
  };

  return (
    <React.Fragment>
      <h1 className="login-heading">
        Active&nbsp;<span>Courses</span>
      </h1>
      ...
      {userDataArray.map((courseData, index) => (
          ...
          >
            ...
            <div className="logoname">
              <h3 className="author">{courseData.createdBy}</h3>
            ...
            {hoveredIndex === index && (
               ...
               <p>{courseData.duration} minutes | {courseData.level} Level</p>
               <p>{courseData.language} Subtitles | {courseData.category}</p>
